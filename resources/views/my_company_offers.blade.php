 ...
 @include('navigation_bar')
  ...
  <!-- Find Job Section Start -->
    <section class="find-job section">
        <div class="container">
        <br>
            <h2 class="section-title" style="color:#337ab7;">My company offers</h2><br>
            <ul>
            <div class="row">
                            ...
                            <a href="{{ route('show_offer', ['id'=>$offer->id]) }}">
                                ...
                                <div class="job-tag">
                                    <div class="pull-left">
                                        ...
                                        <span name="users"><i class="ti-user"></i>Subscribed Users: {{ $offer->getSubscribedUsers->count() }}</span>
                                    ...
                                    <br>
                                    <div class="pull-right">                                
                                        <a href="{{ route('showSubscribedUsersInOffers', ['id'=>$offer->id]) }}" class="btn btn-common btn-rm">Show subscribed users</a>
                                    </div>
                                </div>
                            </a>
                        </li>
